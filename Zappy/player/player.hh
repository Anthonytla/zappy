...
{
    public:
        Player(int x, int y, short int id, short int victory, std::string orientation, sf::TcpSocket *tcpSocket, short int life = 10, short int energy = 2, short int color = 0);
        ...
        void setTcpSocket(sf::TcpSocket* tcpSocket);
